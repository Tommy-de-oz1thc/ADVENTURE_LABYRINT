global _5_words
extern _fopen, _fclose, _fgets, _srand, _rand, _strlen, _system
extern _time
extern _system, _printf, _getch, _puts, _scanf
extern Sentences
extern _strcmp
...
info_txt   db "5 words Sentences",10,0
go_to_txt db "Sentences(1), 5 words sentences(2): ", 0
